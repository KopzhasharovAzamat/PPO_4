...
public class authFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Authenticating...");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Если аутентификация успешна, выполните действия, например, откройте новое окно
        System.out.println("Authentication successful!");
        jLabel4.setForeground(Color.GREEN);
        jLabel4.setText("Correct password");
        StudentsForm studentsForm = new StudentsForm();
        studentsForm.setVisible(true);
        dispose(); // Закрываем текущее окно авторизации
    } else {
        // Если аутентификация не удалась, выведите сообщение об ошибке и измените цвет и текст jLabel4
        jLabel4.setForeground(Color.RED); // Установка красного цвета
